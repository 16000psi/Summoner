...
class TestFormatText(unittest.TestCase):
    def test_non_string_input(self):
        ...
        try:
            ...
            self.fail(
                "Display.format_text() raised TypeError unexpectedly with a string input"
            )
...
class TestTextToLines(unittest.TestCase):
    def test_non_string_input(self):
        ...
        try:
            ...
            self.fail(
                "Display.text_to_lines() raised TypeError unexpectedly with a string input"
            )
...
class TestCentreJustifyLines(unittest.TestCase):
    def test_input_only_list_of_strings(self):
        ...
        try:
            ...
            self.fail(
                "Display.centre_justify_lines() raised TypeError unexpectedly with a string input"
            )
