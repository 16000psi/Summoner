...
class Battle:
    def __init__(self, summoner, challenge_text, preferred_key, battle_intro_text, battle_lost_text, battle_won_text):
    ...
    def fight(self):
        ...
        options.append(Decision(win_name, win_description, win_preferred_key, win_action))
        options.append(Decision(loss_name, loss_description, loss_preferred_key, loss_action))
    ...
    def win(self):
        ...
        options.append(Decision(continue_name, continue_description, continue_preferred_key, continue_action))
